...
const generateTechnologyRoadmap = async (fileUrl) => {
  try {
    const response = await axios.post('/api/generateRoadmap', { fileUrl });
    const roadmap = response.data;
    //console.log('Generated Technology Roadmap:', JSON.stringify(roadmap, null, 2));
...
export default generateTechnologyRoadmap;
