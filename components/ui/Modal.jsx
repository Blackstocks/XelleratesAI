...
const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center overflow-y-auto bg-slate-950/50 backdrop-filter backdrop-blur-sm">
      {!disableBackdrop && (
        <div className="fixed inset-0 bg-slate-950 opacity-50" onClick={onClose}></div>
      )}
