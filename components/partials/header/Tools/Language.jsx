      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className='relative z-[22]'>
          ...
          <Transition
            ...
            leaveTo='opacity-0'
          >
            <Listbox.Options className='absolute min-w-[100px] ltr:right-0 rtl:left-0 md:top-[50px] top-[38px] w-auto max-h-60 overflow-auto border border-slate-200 dark:border-slate-700 rounded bg-white dark:bg-slate-900 mt-1 '>
              {months.map((item, i) => (
                        ...
                        <span className='flex-none'>
                          <span className='lg:w-6 lg:h-6 w-4 h-4 rounded-full inline-block'>
                            <img
                              src={item.image}
                              alt=''
                              className='w-full h-full object-contain relative top-1 rounded-full'
                            />
                          </span>
                        </span>
