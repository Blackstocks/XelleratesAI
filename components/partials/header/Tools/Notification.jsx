...
const notifyLabel = (unreadCount) => {
  return (
    <span className='relative lg:h-[32px] lg:w-[32px] lg:bg-slate-100 text-slate-900 lg:dark:bg-slate-950 dark:text-white cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center'>
      ...
      <div
        ...
        onClick={(e) => {
          if (e.target.tagName === 'A') {
            e.preventDefault(); // Prevent default navigation for child link
        ...
        <div className='flex ltr:text-left rtl:text-right'>
          ...
          <div className='flex-1'>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: item.notification_message }} // Render sanitized HTML
            />
