...
const messagelabel = () => {
  return (
    <span className='relative lg:h-[32px] lg:w-[32px] lg:bg-slate-100 lg:dark:bg-slate-950 dark:text-white text-slate-900 cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center'>
                  ...
                  <div className='flex-none'>
                    <div className='h-8 w-8 bg-white dark:bg-slate-700 rounded-full relative'>
                      ...
                      <img
                        src={item.image}
                        alt=''
                        className='block w-full h-full object-contain rounded-full border hover:border-white border-transparent'
                      />
                    </div>
                  </div>
