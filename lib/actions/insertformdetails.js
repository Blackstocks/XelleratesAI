...
export const updateCTODetails = async (companyId, formData) => {
  try {
    ...
    if (formData.cto_name) {
      fieldsToUpdate.cto_name = formData.cto_name;
    }
    if (formData.cto_email) {
      fieldsToUpdate.cto_email = formData.cto_email;
    }
    if (formData.cto_mobile) {
      fieldsToUpdate.cto_mobile = formData.cto_mobile;
    }
    if (formData.cto_linkedin) {
      fieldsToUpdate.cto_linkedin = formData.cto_linkedin;
    }
    if (formData.tech_team_size) {
      fieldsToUpdate.tech_team_size = formData.tech_team_size;
    }
    if (formData.mobile_app_link_ios) {
      fieldsToUpdate.mobile_app_link_ios = formData.mobile_app_link_ios;
    }
    if (formData.mobile_app_link_android) {
      fieldsToUpdate.mobile_app_link_android = formData.mobile_app_link_android;
    }
    if (formData.technology_roadmap) {
      fieldsToUpdate.technology_roadmap = formData.technology_roadmap;
    }
    ...
    if (!data || data.length === 0) {
      console.error("No data returned after updating CTO details.");
      return { error: "No data returned" };
    }
    ...
    return { error: `Failed to update CTO details: ${error.message}` };
  }
};
...
export const updateFounderInformation = async (
  ...
  try {
    ...
    if (formData.founder_name) {
      fieldsToUpdate.founder_name = formData.founder_name;
    }
    if (formData.founder_email) {
      fieldsToUpdate.founder_email = formData.founder_email;
    }
    if (formData.founder_mobile) {
      fieldsToUpdate.founder_mobile = formData.founder_mobile;
    }
    if (formData.founder_linkedin) {
      fieldsToUpdate.founder_linkedin = formData.founder_linkedin;
    }
    if (formData.degree_name) {
      fieldsToUpdate.degree_name = formData.degree_name;
    }
    if (formData.college_name) {
      fieldsToUpdate.college_name = formData.college_name;
    }
    if (formData.graduation_year) {
      fieldsToUpdate.graduation_year = formData.graduation_year;
    }
    if (formData.advisors) {
      fieldsToUpdate.advisors = formData.advisors; // Ensure correct handling as JSONB
    }
    if (formData.co_founders) {
      fieldsToUpdate.co_founders = formData.co_founders; // Ensure correct handling as JSONB
    }
    if (uploadedFiles.co_founder_agreement) {
      fieldsToUpdate.co_founder_agreement = uploadedFiles.co_founder_agreement;
    }
    ...
    console.error("Error updating founder information:", error);
    return { error: `Failed to update founder information: ${error.message}` };
  }
};
