...
const Equity = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 relative">
      <main className={`flex-1 p-8 ${showPanModal || showCompletionModal || showProgressModal ? 'blur-sm' : ''}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12">
          <div className="cursor-pointer" onClick={checkProfileCompletion}>
            <img src="/assets/images/tools/equityInvestor.png" alt="Equity Investor" className="rounded w-full h-50 object-cover" />
          </div>
          <div className="cursor-pointer">
            <img src="/assets/images/tools/equityInvestment.png" alt="Equity Investment" className="rounded w-full h-50 object-cover" />
          </div>
        </div>
      </main>
      ...
      {showPanModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded shadow-lg relative">
            <button className="absolute top-2 right-2" onClick={() => setShowPanModal(false)}>X</button>
      ...
      {showCompletionModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded shadow-lg relative">
            <button className="absolute top-2 right-2" onClick={() => setShowCompletionModal(false)}>X</button>
            <h2 className="text-xl font-bold mb-4">Profile Incomplete</h2>
            <p>Please complete your profile first before connecting with an investor.</p>
            <button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded shadow-lg relative">
            <div className="flex flex-col items-center">
              <p className="mb-4">Our Xellerates AI model is analyzing your profile...</p>
