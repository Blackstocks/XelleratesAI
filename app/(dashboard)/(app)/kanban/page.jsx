...
//       } else {
//         window.location.reload(); // Reload the page to reflect changes immediately
//       }
//     } catch (error) {
...
//       <div className="flex justify-between items-center mb-4 bg-white dark:bg-slate-800 rounded shadow-base p-4">
//         <div>
//           <h4 className="font-medium lg:text-xl text-lg text-slate-900 dark:text-white">
//             Today's Summary
//           </h4>
...
//           className="bg-slate-800 dark:bg-slate-600 hover:bg-slate-700 text-sm text-white"
